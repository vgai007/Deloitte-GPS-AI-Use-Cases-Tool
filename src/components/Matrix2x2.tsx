...
export function Matrix2x2({
  ...
  return (
    <div className="bg-card rounded-xl border border-border p-6 shadow-sm">
      ...
      <div className="flex">
        <div
          className="flex flex-col justify-center items-center pr-4 -rotate-180"
      ...
      <div className="mt-6 pt-4 border-t border-border flex flex-wrap gap-4 text-xs">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-muted-foreground">
            Strategic: High complexity, High impact
          </span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-3 h-3 rounded-full bg-amber-600"></div>
          <span className="text-muted-foreground">
            Consider: High complexity, Low impact
          </span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-3 h-3 rounded-full bg-slate-500"></div>
          <span className="text-muted-foreground">
            Low Priority: Low complexity, Low impact
          </span>
        </div>
      </div>
    </div>
